...
import 'package:workout_helper/pages/nutrition/diet_pattern.dart';
import 'package:workout_helper/pages/nutrition/macro_nutrition_panel.dart';
import 'package:workout_helper/pages/nutrition/recorde_line.dart';
import 'package:workout_helper/pages/nutrition/sample_meal.dart';
        ...
        children: [
          ...
          ...todayRecords.map((NutritionRecord nr) {
            return ExpansionPanel(
              ...
              body: MacroNutritionPanel(nr, [
                SampleMeal(nutritionRecord: nr),
                RecordLine(nutritionRecord: nr),
              ]),
            );
          })
        ],
