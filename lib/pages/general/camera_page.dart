...
import 'package:workout_helper/pages/general/show_clip_result.dart';
...
class _CameraCaptureState extends State<CameraCapture>
  ...
  Widget _captureControlRowWidget() {
    ...
    if (widget.canUploadVideo) {
      defaultWidgets.add(IconButton(
  ...
  void onTakePictureButtonPressed() {
    takePicture().then((String filePath) {
      if (mounted) {
        ...
        if (filePath != null) {
          goToResult(filePath, false);
        }
      }
    });
  }

  void goToResult(String filePath, bool isVideo) async {
    VideoPlayerController _cameraVideoPlayerController;
    if (isVideo) {
      _cameraVideoPlayerController = VideoPlayerController.file(File(filePath));
      await _cameraVideoPlayerController.initialize();
    }
    Navigator.of(context)
        .push(MaterialPageRoute<String>(
            builder: (context) => ShowClipResult(
                  filePath: filePath,
                  remoteStoreLocation: widget.remoteStoreLocation,
                  isVideo: isVideo,
                  videoPlayerController: _cameraVideoPlayerController,
                )))
      ...
      debugPrint('uploaded, stored @' + filePath);
      widget.fileUploaded(filePath);
    });
  }
